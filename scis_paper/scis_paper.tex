...
%不用了的2×2排版
	...
	\begin{figure}[t]
		\begin{minipage}[t]{0.33\textwidth}
			\vspace{10pt}
			\centering
			\subfloat[cap1]{\includegraphics[width=2.0in]{res_t5g_ttsn.pdf}}
			\newline
			\subfloat[cap1]{\includegraphics[width=2.0in]{signal_t5g.pdf}}
			\caption{Caps for image}
		\end{minipage}
		\begin{minipage}[t]{0.66\textwidth}
			\vspace{0pt}
			\centering
			\subfloat[cap1]{\includegraphics[width=2.0in]{t_5G_TC.pdf}}
			\hfil
			\subfloat[cap1]{\includegraphics[width=2.0in]{t_tsn_TC.pdf}}
			\newline
			\subfloat[cap1]{\includegraphics[width=2.0in]{t_5G_NS.pdf}}
			\hfil
			\subfloat[cap1]{\includegraphics[width=2.0in]{t_tsn_NS.pdf}}
			\caption{Caps for image2}
		\end{minipage}
	\end{figure}
